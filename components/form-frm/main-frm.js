export class MainFrm extends HTMLElement{
    constructor(){
        super()
        this.render();
    }
    render(){
        this.innerHTML=/*html*/`
            <ul class="nav">
                <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="#frmData">Registro de personal</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="#">REGISTRO FLOTA AEREA</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="#">RUTAS AEREAS</a>
                </li>
                <li class="nav-item">
...
customElements.define("main-frm", MainFrm);
